        ...
        <div class="rounded-xl mt-10 border-2 border-black shadow-black p-5">
            ...
            <input type="text" name="target" id="target" value="{{ old('target', $target->target ?? '') }}" 
                ...
                <button type="button"
                    ...
                    <button type="submit" 
                            name="action"
                            value="{{ isset($target) ? 'perbarui' : 'simpan' }}"
                    class=" shadow-black flex-1 py-2 rounded-xl bg-secondary text-black font-pilcrow font-pilcrow-semibold text-base hover:bg-tertiary">
