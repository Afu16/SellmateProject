...
<body class="bg-white">
    <div class="p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <!-- Search Bar -->
            <div class="relative flex items-center border-2 border-black bg-white rounded-xl py-2 px-3 w-32">
                ...
                <input type="text" placeholder="Search" class="bg-transparent outline-none text-black text-sm font-quicksand font-quicksand-regular">
            </div>
        </div>
