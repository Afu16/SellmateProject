...
<div class="pt-8 px-4">
    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        <!-- Card 2 -->
        <div class="relative rounded-xl overflow-hidden shadow-md bg-gray-900">
            <img src="{{ asset('assets/img/it-career.jpg') }}" alt="Karir di bidang IT" class="w-full h-40 object-cover opacity-70">
            <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent"></div>
            <div class="absolute bottom-0 left-0 p-4 w-full">
        ...
        <!-- Card 3 -->
        <div class="relative rounded-xl overflow-hidden shadow-md bg-gray-900">
            <img src="{{ asset('assets/img/content-creator.jpg') }}" alt="Tips content creator" class="w-full h-40 object-cover opacity-70">
            <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent"></div>
        ...
        <!-- Card 4 -->
        <div class="relative rounded-xl overflow-hidden shadow-md bg-gray-900">
            <img src="{{ asset('assets/img/wirausaha.jpg') }}" alt="Memulai wirausaha" class="w-full h-40 object-cover opacity-70">
            <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent"></div>
            <div class="absolute top-0 left-0 p-2">
