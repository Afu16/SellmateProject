    ...
    <div class="hidden md:block">
        ...
        <div class="flex flex-row">
            ...
            <div class="w-full p-5">
                ...
                <table class="w-full border-2 border-black shadow-black p-5 rounded-md">
                    <tr>
                        <td>
                            <h6 class="text-xs font-pilcrow font-pilcrow-rounded font-bold text-black">Katalog Produk</h6>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <div class="w-[1vw] h-[1vh] bg-black rounded-full"></div>
                        </td>
                    </tr>
                    <tr class=" text-xs">
                        <td>1</td>
