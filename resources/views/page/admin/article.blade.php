            ...
            <div class="w-full p-5">
                 ...
                 <div class="w-full  border-2 border-black shadow-black rounded-lg">                            
                        <div class="flex justify-between items-center p-3">
                            ...
                            <p class="text-[1.2vw] font-quicksand font-quicksand-medium text-black w-[6vw] text-nowrap">Tanggal Post</p>
                        ...
                        <div class="">
                            ...
                            <div class="flex justify-between border-b-2 border-b-black items-center p-3 relative" x-data="{open:false}" @keydown.escape.window="open=false">
                                ...
                                <img class="border-2 border-black rounded-md" src="{{ asset('storage/' . $article->thumbnail) }}" alt="Produk" width="50" height="50">
                            </p>
                                <p class="text-[1.2vw] font-quicksand font-quicksand-medium text-black w-[4vw] text-nowrap">{{ $article->title }}</p>
                                <p class="text-[1.2vw] font-quicksand font-quicksand-medium text-black w-[5vw] text-nowrap">{{ $article->author }}</p>
                                <p class="text-[1.2vw] font-quicksand font-quicksand-medium text-black w-[6vw] text-nowrap">{{ $article->created_at->format('d-m-Y') }}</p>
