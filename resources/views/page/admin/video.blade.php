            ...
            <div class="w-full p-5">
                <div class="flex flex-row">
                    <div class="w-full">
                        ...
                        <button class="bg-tertiary px-4 py-1 text-nowrap text-xs rounded-xl border-2 border-black shadow-black">
                            Semua
                        </button>
                        <button class="bg-white px-4 py-1 text-nowrap text-xs rounded-xl border-2 border-black shadow-black">
                            Tips
                        </button>
                        <button class="bg-white px-4 py-1 text-nowrap text-xs rounded-xl border-2 border-black shadow-black">
                            Inspirasi
                        </button>
                        <button class="bg-secondary px-4 py-1 text-nowrap text-xs rounded-xl border-2 border-black shadow-black">
                            Tambah Video
                        </button>
                    </div>
                    ...
                    <div class="mt-5 grid grid-cols-3 gap-4">
                        <div class="bg-white px-4 py-1 text-nowrap text-xs rounded-xl border-2 border-black shadow-black">
                              <div class="flex flex-col text-xs  rounded-xl gap-2">
                                <img width="200px"  src="/storage/profile/QzBiJ2sbQ5yIgcy2vEOEOA1R7hwyNYvwdmzbwez5.jpg" alt="check-icon" class="items-center rounded-xl border-1 border-black justify-self-center">
